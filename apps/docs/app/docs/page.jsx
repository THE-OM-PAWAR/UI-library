    ...
    <div className="container max-w-4xl mx-auto py-10 px-4">
      ...
      <section className="mb-16">
        ...
        <p className="text-muted-foreground mb-6">
          Browse our collection of reusable components. Each component is fully customizable
      ...
      <section className="mb-16">
        ...
        <div className="grid gap-4 sm:grid-cols-2 mt-6">
          ...
          >
            <h3 className="font-semibold text-lg mb-2 group-hover:text-foreground">Button</h3>
