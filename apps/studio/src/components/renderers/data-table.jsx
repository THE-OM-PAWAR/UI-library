...
function DataTableDemo({ DataTable, Button, DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, customClassName }) {
  const data = useMemo(
    () => [
  ...
  const columns = useMemo(
    ...
    [Button, DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator]
  );
