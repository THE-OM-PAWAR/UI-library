    ...
    return (
        <div className="container max-w-4xl px-4 py-10 mx-auto">
            ...
            <DocsSection>
                ...
                <CommandBlock command="npm install -g shery-ui" />
            </DocsSection>
            ...
            <DocsSection>
                ...
                <CommandBlock command="npx shery-ui init" />
  ...
  "aliases": {
    ...
    "lib": "@/lib"
            ...
            <DocsSection>
                ...
                <CommandBlock command="npx shery-ui add [components...]" />
                ...
                <div className="mb-6 space-y-3">
                    <div>
                        ...
                        <CommandBlock command="npx shery-ui add button" />
                    </div>
                    <div>
                        <p className="text-xs text-muted-foreground mb-1.5">
                            Add multiple components at once:
                        </p>
                        <CommandBlock command="npx shery-ui add button card dialog" />
                    </div>
                    <div>
                        <p className="text-xs text-muted-foreground mb-1.5">
                            Interactive picker (no arguments):
                        </p>
                        <CommandBlock command="npx shery-ui add" />
                    </div>
                </div>
            ...
            <DocsSection>
                ...
                <CommandBlock command="npx shery-ui list" />
                    ...
                    {[
                        {
                            ...
                            command: "npx shery-ui init",
                        },
                        {
                            step: "2",
                            label: "Add your first component",
                            command: "npx shery-ui add button",
                        },
                        {
                            step: "3",
