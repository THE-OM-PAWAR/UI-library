...
// ΓöÇΓöÇΓöÇ ComboboxTrigger

const ComboboxTrigger = React.forwardRef(
    (
        { className, children, placeholder = "Select optionΓÇª", ...props },
        ref
    ) => {
...
// ΓöÇΓöÇΓöÇ ComboboxSearch
const ComboboxSearch = React.forwardRef(
    ({ className, placeholder = "SearchΓÇª", ...props }, ref) => {
